      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-slate-900">
            Kenyamanan <span className="text-blue-600">Profesional</span> Dari SSI
          </h1>
          
          <p className="text-lg text-slate-600 max-w-lg leading-relaxed">
            SSI menyediakan solusi furnitur kantor B2B kelas dunia. Dari kursi eksekutif hingga area lounge, kami memastikan tim Anda bekerja dengan kenyamanan maksimal.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#products" className="px-8 py-4 bg-slate-900 text-white rounded-xl font-semibold hover:bg-slate-800 transition-all text-center shadow-xl shadow-slate-200">
              Lihat Koleksi
            </a>
            <a href="#contact" className="px-8 py-4 border-2 border-slate-200 text-slate-700 rounded-xl font-semibold hover:bg-slate-50 transition-all text-center">
              Penawaran Khusus
            </a>
          </div>
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-6 left-6 right-6 glass p-6 rounded-2xl z-20 shadow-xl flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Standard Internasional BIFMA</p>
            </div>
          </div>
        </div>
      </div>
